    ...
    try:
        ...
        default_faq_items = [
            ...
            ('Что такое этапы мероприятия?', 
             '<p>Каждое мероприятие состоит из нескольких этапов:</p><ul><li><strong>Предварительная регистрация</strong> - ранний этап для желающих участвовать</li><li><strong>Основная регистрация</strong> - основной период регистрации</li><li><strong>Закрытие регистрации</strong> - регистрация завершена</li><li><strong>Жеребьёвка</strong> - случайное распределение получателей подарков</li><li><strong>Отправка подарков</strong> - период отправки подарков</li><li><strong>Обмен подарками</strong> - день, когда подарки вручаются</li><li><strong>Послепраздничное настроение</strong> - период для обмена впечатлениями</li></ul>', 
             'events', 20),
