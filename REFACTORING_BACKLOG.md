...
| R-209 | Blueprint `meta` — `/avatars/image`, titles/awards/roles public views | todo | R-201 |
| R-210 | Сервисный слой: `services/gwars_auth.py`, `services/avatars.py`, `services/telegram.py` | todo | R-202, R-209 |
